...
# v.1.9.2.5     jan2020 - Introduces a modification to use the new files created in 'ExecutionLevels.pm@only_DESeq2', that serve as a new input for DESeq2, that do not contain
#			  flat pattern and background level genes (avoids runing htseqcount again). Function 'createFullTable' was deleted here
